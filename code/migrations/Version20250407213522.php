 ...
 */
final class Version20250407213522 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE car_rental_services (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) DEFAULT NULL, email VARCHAR(255) NOT NULL, garage_name VARCHAR(255) NOT NULL, garage_address VARCHAR(255) NOT NULL, phone_number VARCHAR(255) NOT NULL, working_hours VARCHAR(255) NOT NULL, contact_info VARCHAR(255) NOT NULL, service_mail VARCHAR(255) NOT NULL, service_name VARCHAR(255) NOT NULL, service_location VARCHAR(255) NOT NULL, service_hours VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE mechanic (id INT AUTO_INCREMENT NOT NULL, location_id INT NOT NULL, role_id INT NOT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) DEFAULT NULL, email VARCHAR(255) NOT NULL, garage_name VARCHAR(255) NOT NULL, garage_address VARCHAR(255) NOT NULL, phone_number VARCHAR(255) NOT NULL, working_hours VARCHAR(255) NOT NULL, status VARCHAR(20) NOT NULL, telephone_garage VARCHAR(15) NOT NULL, garage_email VARCHAR(255) NOT NULL, INDEX IDX_7137DE7964D218E (location_id), INDEX IDX_7137DE79D60322AC (role_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, payment_id INT NOT NULL, delivery_id INT NOT NULL, status VARCHAR(255) NOT NULL, order_date DATETIME NOT NULL, delivery_date DATETIME DEFAULT NULL, INDEX IDX_F52993984C3A3BB (payment_id), INDEX IDX_F529939812136921 (delivery_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE sellers (id INT AUTO_INCREMENT NOT NULL, shop_id INT NOT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) DEFAULT NULL, email VARCHAR(255) NOT NULL, garage_name VARCHAR(255) NOT NULL, garage_address VARCHAR(255) NOT NULL, phone_number VARCHAR(255) NOT NULL, working_hours VARCHAR(255) NOT NULL, contact_info VARCHAR(255) NOT NULL, shop_name VARCHAR(255) NOT NULL, shop_email VARCHAR(255) NOT NULL, shop_phone VARCHAR(15) NOT NULL, INDEX IDX_AFFE6BEF4D16C4DD (shop_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE service_client (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) DEFAULT NULL, email VARCHAR(255) NOT NULL, service_details VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
