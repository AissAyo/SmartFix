...
final class Version20250323005837 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `Or_der` DROP INDEX IDX_F52993981AD5CDBF, ADD UNIQUE INDEX UNIQ_F52993981AD5CDBF (cart_id)');
        $this->addSql('ALTER TABLE `Or_der` DROP FOREIGN KEY FK_F52993984C3A3BB');
        $this->addSql('DROP INDEX IDX_F52993984C3A3BB ON `Or_der`');
        $this->addSql('ALTER TABLE `Or_der` DROP payment_id');
        $this->addSql('ALTER TABLE payment ADD amount NUMERIC(10, 2) NOT NULL, ADD currency VARCHAR(3) NOT NULL, ADD status VARCHAR(255) NOT NULL, ADD transaction_id VARCHAR(255) NOT NULL, ADD payment_gateway VARCHAR(255) NOT NULL, ADD Or_der_id INT NOT NULL');
        $this->addSql('ALTER TABLE payment ADD CONSTRAINT FK_6D28840D8D9F6D38 FOREIGN KEY (Or_der_id) REFERENCES `Or_der` (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_6D28840D2FC0CB0F ON payment (transaction_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_6D28840D8D9F6D38 ON payment (Or_der_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (product_id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, cart_id INT NOT NULL, Or_der_id INT NOT NULL, name VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, price DOUBLE PRECISION NOT NULL, description VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, stock_quantity INT NOT NULL, INDEX IDX_D34A04AD8D9F6D38 (Or_der_id), INDEX IDX_D34A04AD1AD5CDBF (cart_id), INDEX IDX_D34A04AD12469DE2 (category_id), PRIMARY KEY(product_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE payment DROP amount, DROP currency, DROP status, DROP transaction_id, DROP payment_gateway, DROP Or_der_id');
        ...
        $this->addSql('ALTER TABLE `Or_der` DROP INDEX UNIQ_F52993981AD5CDBF, ADD INDEX IDX_F52993981AD5CDBF (cart_id)');
        $this->addSql('ALTER TABLE `Or_der` ADD payment_id INT NOT NULL');
        $this->addSql('ALTER TABLE `Or_der` ADD CONSTRAINT FK_F52993984C3A3BB FOREIGN KEY (payment_id) REFERENCES payment (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('CREATE INDEX IDX_F52993984C3A3BB ON `Or_der` (payment_id)');
