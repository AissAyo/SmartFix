 ...
 */
final class Version20250305093058 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `admin` (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) DEFAULT NULL, email VARCHAR(255) NOT NULL, reset_token VARCHAR(255) DEFAULT NULL, token_expiration DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE car_api (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE car_rental (id INT AUTO_INCREMENT NOT NULL, location_id INT NOT NULL, car_rental_service_id INT NOT NULL, name VARCHAR(255) NOT NULL, logo VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, UNIQUE INDEX UNIQ_E712E8F64D218E (location_id), INDEX IDX_E712E8FC9C86E00 (car_rental_service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE car_rental_services (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) DEFAULT NULL, email VARCHAR(255) NOT NULL, reset_token VARCHAR(255) DEFAULT NULL, token_expiration DATETIME DEFAULT NULL, garage_name VARCHAR(255) NOT NULL, garage_address VARCHAR(255) NOT NULL, phone_number VARCHAR(255) NOT NULL, working_hours VARCHAR(255) NOT NULL, service_mail VARCHAR(255) NOT NULL, service_name VARCHAR(255) NOT NULL, service_hours VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cars (id INT AUTO_INCREMENT NOT NULL, car_rental_id INT NOT NULL, car_api_id INT NOT NULL, model VARCHAR(255) NOT NULL, brand VARCHAR(255) NOT NULL, status TINYINT(1) NOT NULL, daily_rate DOUBLE PRECISION NOT NULL, INDEX IDX_95C71D14A02DD105 (car_rental_id), INDEX IDX_95C71D144CFED5CA (car_api_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cart (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, total_amount DOUBLE PRECISION NOT NULL, UNIQUE INDEX UNIQ_BA388B719EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE category_product (id INT AUTO_INCREMENT NOT NULL, shop_id INT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_149244D34D16C4DD (shop_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE clients (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) DEFAULT NULL, email VARCHAR(255) NOT NULL, reset_token VARCHAR(255) DEFAULT NULL, token_expiration DATETIME DEFAULT NULL, verification_status TINYINT(1) NOT NULL, date_inscription DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', loyalty_points INT NOT NULL, address VARCHAR(255) DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, discr VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE critiques (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, reservation_id INT NOT NULL, rating INT NOT NULL, INDEX IDX_2712BED919EB6921 (client_id), UNIQUE INDEX UNIQ_2712BED9B83297E7 (reservation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE garage_service (id INT AUTO_INCREMENT NOT NULL, garage_id INT NOT NULL, service_id INT NOT NULL, car_api_id INT NOT NULL, price DOUBLE PRECISION NOT NULL, INDEX IDX_67DD7642C4FFF555 (garage_id), INDEX IDX_67DD7642ED5CA9E6 (service_id), INDEX IDX_67DD76424CFED5CA (car_api_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE garage_service_reservation (garage_service_id INT NOT NULL, reservation_id INT NOT NULL, INDEX IDX_4457A2E09458ECE0 (garage_service_id), INDEX IDX_4457A2E0B83297E7 (reservation_id), PRIMARY KEY(garage_service_id, reservation_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE garages (id INT AUTO_INCREMENT NOT NULL, mechanic_id INT NOT NULL, location_id INT NOT NULL, email_garage VARCHAR(255) NOT NULL, rating DOUBLE PRECISION NOT NULL, status VARCHAR(20) NOT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_8C4330E29A67DB00 (mechanic_id), UNIQUE INDEX UNIQ_8C4330E264D218E (location_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE mechanic (id INT AUTO_INCREMENT NOT NULL, location_id INT NOT NULL, role_id INT NOT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) DEFAULT NULL, email VARCHAR(255) NOT NULL, reset_token VARCHAR(255) DEFAULT NULL, token_expiration DATETIME DEFAULT NULL, garage_name VARCHAR(255) NOT NULL, garage_address VARCHAR(255) NOT NULL, phone_number VARCHAR(255) NOT NULL, working_hours VARCHAR(255) NOT NULL, status VARCHAR(20) NOT NULL, telephone_garage VARCHAR(15) NOT NULL, garage_email VARCHAR(255) NOT NULL, INDEX IDX_7137DE7964D218E (location_id), INDEX IDX_7137DE79D60322AC (role_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, cart_id INT NOT NULL, delivery_id INT NOT NULL, status VARCHAR(255) NOT NULL, order_date DATETIME NOT NULL, delivery_date DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_F52993981AD5CDBF (cart_id), INDEX IDX_F529939812136921 (delivery_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE payment (id INT AUTO_INCREMENT NOT NULL, order_id INT NOT NULL, method VARCHAR(255) NOT NULL, payment_date DATETIME NOT NULL, amount NUMERIC(10, 2) NOT NULL, currency VARCHAR(3) NOT NULL, status VARCHAR(255) NOT NULL, transaction_id VARCHAR(255) NOT NULL, payment_gateway VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_6D28840D2FC0CB0F (transaction_id), UNIQUE INDEX UNIQ_6D28840D8D9F6D38 (order_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, shop_id INT NOT NULL, category_product_id INT NOT NULL, name VARCHAR(255) NOT NULL, price DOUBLE PRECISION NOT NULL, description VARCHAR(255) NOT NULL, stock_quantity INT NOT NULL, INDEX IDX_D34A04AD4D16C4DD (shop_id), INDEX IDX_D34A04AD639A3624 (category_product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reservations (id INT AUTO_INCREMENT NOT NULL, vehicle_id INT NOT NULL, reservation_date DATETIME NOT NULL, client_id INT NOT NULL, status VARCHAR(20) NOT NULL, estimated_price NUMERIC(10, 2) NOT NULL, notes LONGTEXT DEFAULT NULL, INDEX IDX_4DA239545317D1 (vehicle_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE sellers (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) DEFAULT NULL, email VARCHAR(255) NOT NULL, reset_token VARCHAR(255) DEFAULT NULL, token_expiration DATETIME DEFAULT NULL, garage_name VARCHAR(255) NOT NULL, garage_address VARCHAR(255) NOT NULL, phone_number VARCHAR(255) NOT NULL, working_hours VARCHAR(255) NOT NULL, contact_info VARCHAR(255) NOT NULL, shop_name VARCHAR(255) NOT NULL, shop_email VARCHAR(255) NOT NULL, shop_phone VARCHAR(15) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE service_client (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) DEFAULT NULL, email VARCHAR(255) NOT NULL, reset_token VARCHAR(255) DEFAULT NULL, token_expiration DATETIME DEFAULT NULL, service_details VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE shop (id INT AUTO_INCREMENT NOT NULL, seller_id INT NOT NULL, location_id INT NOT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_AC6A4CA28DE820D9 (seller_id), UNIQUE INDEX UNIQ_AC6A4CA264D218E (location_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE vehicules (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, car_api_id INT NOT NULL, model VARCHAR(255) NOT NULL, brand VARCHAR(255) NOT NULL, license_plate VARCHAR(255) NOT NULL, INDEX IDX_78218C2D19EB6921 (client_id), INDEX IDX_78218C2D4CFED5CA (car_api_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE car_rental ADD CONSTRAINT FK_E712E8F64D218E FOREIGN KEY (location_id) REFERENCES location (id)');
        $this->addSql('ALTER TABLE car_rental ADD CONSTRAINT FK_E712E8FC9C86E00 FOREIGN KEY (car_rental_service_id) REFERENCES car_rental_services (id)');
        ...
        $this->addSql('ALTER TABLE category_product ADD CONSTRAINT FK_149244D34D16C4DD FOREIGN KEY (shop_id) REFERENCES shop (id)');
        ...
        $this->addSql('ALTER TABLE garage_service ADD CONSTRAINT FK_67DD7642C4FFF555 FOREIGN KEY (garage_id) REFERENCES garages (id)');
        $this->addSql('ALTER TABLE garage_service ADD CONSTRAINT FK_67DD7642ED5CA9E6 FOREIGN KEY (service_id) REFERENCES service (id)');
        $this->addSql('ALTER TABLE garage_service ADD CONSTRAINT FK_67DD76424CFED5CA FOREIGN KEY (car_api_id) REFERENCES car_api (id)');
        $this->addSql('ALTER TABLE garage_service_reservation ADD CONSTRAINT FK_4457A2E09458ECE0 FOREIGN KEY (garage_service_id) REFERENCES garage_service (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE garage_service_reservation ADD CONSTRAINT FK_4457A2E0B83297E7 FOREIGN KEY (reservation_id) REFERENCES reservations (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE garages ADD CONSTRAINT FK_8C4330E29A67DB00 FOREIGN KEY (mechanic_id) REFERENCES mechanic (id)');
        $this->addSql('ALTER TABLE garages ADD CONSTRAINT FK_8C4330E264D218E FOREIGN KEY (location_id) REFERENCES location (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE car_rental DROP FOREIGN KEY FK_E712E8F64D218E');
        $this->addSql('ALTER TABLE car_rental DROP FOREIGN KEY FK_E712E8FC9C86E00');
        ...
        $this->addSql('ALTER TABLE category_product DROP FOREIGN KEY FK_149244D34D16C4DD');
        ...
        $this->addSql('ALTER TABLE garage_service DROP FOREIGN KEY FK_67DD76424CFED5CA');
        $this->addSql('ALTER TABLE garage_service_reservation DROP FOREIGN KEY FK_4457A2E09458ECE0');
        $this->addSql('ALTER TABLE garage_service_reservation DROP FOREIGN KEY FK_4457A2E0B83297E7');
        $this->addSql('ALTER TABLE garages DROP FOREIGN KEY FK_8C4330E29A67DB00');
        $this->addSql('ALTER TABLE garages DROP FOREIGN KEY FK_8C4330E264D218E');
        ...
        $this->addSql('DROP TABLE car_api');
        ...
        $this->addSql('DROP TABLE garage_service_reservation');
