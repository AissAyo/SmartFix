 ...
 */
final class Version20250422214405 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE car_api (id INT AUTO_INCREMENT NOT NULL, make VARCHAR(100) NOT NULL, model VARCHAR(100) NOT NULL, year INT NOT NULL, trim VARCHAR(100) DEFAULT NULL, horsepower INT DEFAULT NULL, torque INT DEFAULT NULL, engine VARCHAR(50) DEFAULT NULL, fuel_type VARCHAR(50) DEFAULT NULL, transmission VARCHAR(50) DEFAULT NULL, drivetrain VARCHAR(50) DEFAULT NULL, body_type VARCHAR(50) DEFAULT NULL, doors INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE garages (id INT AUTO_INCREMENT NOT NULL, mechanic_id INT DEFAULT NULL, location_id INT DEFAULT NULL, email_garage VARCHAR(255) NOT NULL, garage_address VARCHAR(255) NOT NULL, rating DOUBLE PRECISION NOT NULL, status VARCHAR(20) NOT NULL, name VARCHAR(255) NOT NULL, working_hours VARCHAR(255) DEFAULT NULL, phone_number VARCHAR(20) DEFAULT NULL, logo_profil VARCHAR(255) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, logo VARCHAR(255) DEFAULT NULL, INDEX IDX_8C4330E29A67DB00 (mechanic_id), UNIQUE INDEX UNIQ_8C4330E264D218E (location_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE reservations (id INT AUTO_INCREMENT NOT NULL, vehicle_id INT DEFAULT NULL, service_id INT NOT NULL, reservation_date DATETIME NOT NULL, status VARCHAR(20) NOT NULL, estimated_price NUMERIC(10, 2) NOT NULL, notes LONGTEXT DEFAULT NULL, INDEX IDX_4DA239545317D1 (vehicle_id), INDEX IDX_4DA239ED5CA9E6 (service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE review (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, garage_service_id INT DEFAULT NULL, content LONGTEXT NOT NULL, rating INT NOT NULL, INDEX IDX_794381C619EB6921 (client_id), INDEX IDX_794381C69458ECE0 (garage_service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE services (id INT AUTO_INCREMENT NOT NULL, category_service_id INT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, price NUMERIC(10, 2) NOT NULL, status VARCHAR(20) NOT NULL, INDEX IDX_7332E169CB42F998 (category_service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
