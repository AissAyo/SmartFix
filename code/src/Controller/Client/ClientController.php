...
//    public function index(Client $client,EntityManagerInterface $entityManager): Response
//    {
...
//            }
////dd($clientPhotoProfilFile);
//            // dd($client->getPhotoProfil());
